...
non_auth_routes = ["/admin/login","/home","/admin/signup","/admin/api/signup","/admin/api/login","/favicon.ico","/admin/api/event/get","/admin/api/login","/api/event/register","/static/zync-logo.png"]
